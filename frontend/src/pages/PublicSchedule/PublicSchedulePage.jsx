...
function PublicSchedulePage() {
  ...
  return (
    <div className="animate-fade-in">
      {/* Cabecera de Página Estilo SIAE */}
      <Row justify="space-between" align="middle" style={{ marginBottom: 20 }}>
        <Col>
          <Title level={3} style={{ color: '#0A2647', margin: 0 }}>🌊 Calendario de Disponibilidad</Title>
          <Text type="secondary">Consulta de disponibilidad y programación de las embarcaciones de investigación del DEO</Text>
        </Col>
      </Row>
